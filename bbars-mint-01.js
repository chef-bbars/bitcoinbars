...
const contractAddress = "0xeA256157639A786B8705b3166f13FB6182Db2826";
...
async function mint() {
    ...
    document.querySelector("#nftLink").innerHTML = `<a src="https://rinkeby.etherscan.io/tx/${tx.hash}">https://rinkeby.etherscan.io/tx/${tx.hash}</a>`;
    } catch(err) { 
